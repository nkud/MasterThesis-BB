#+TITLE: 修士研究
#+AUTHOR: Naoki Ueda
#+OPTIONS: \n:nil H:2 toc:t author:nil email:nil timestamp:t creator:nil num:nil
#+LANGUAGE: ja
#+LaTeX_CLASS: thesis
#+STARTUP: content
#+HTML_HEAD: <style type="text/css">body {font-family:serif;font-size:0.8em;}</style>
...
*** HOLD 本論文の構成を述べる
** 参考文献
- Robert D. Schreiber, Lloyd J. Old, Mark J. Smyth, Cancer Immunoediting: Integrating Immunity’s Roles in Cancer Suppression and Promotion.[fn:1]
[fn:1] http://www.sciencemag.org/content/331/6024/1565.short
* 構成テンプレート
** 序論
*** 背景説明
- 他分野である可能性が高い。
...
* 論文
** ABiasedCompetitionTheoryOfCytotoxicTLymphocyteInteractionWithTumorNodules
